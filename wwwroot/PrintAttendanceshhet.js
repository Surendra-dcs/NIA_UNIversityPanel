function printTable() {
    ...
    parts.push('<html><head><title>Practical / Viva Attendance Sheet</title>');
    parts.push('<style>');
    ...
    // Header for repeat on every page
    parts.push('thead.repeat-header { display: table-header-group; }');

    // Outer table used as page border
    ...
    parts.push('table.main-table th { border: 1px solid #000; padding: 5px 3px; text-align: center; font-weight: bold; font-size: 10.5px; vertical-align: middle; background: #fff; }');
    ...
    parts.push('<p class="award-line">Practical / Viva Attendance Sheet Paper-: ' + subjectName + '</p>');
    parts.push('</div>');
    parts.push('</div>');
    

    // Main table — thead repeats on each page automatically
    parts.push('<table class="main-table">');
    parts.push('<thead>');
    parts.push('<tr>');
    parts.push('<th style="width:6%;">S.No</th>');
    parts.push('<th style="width:26%;">Student Name</th>');
    parts.push('<th style="width:20%;">Enrollment No.</th>');
    parts.push('<th style="width:13%;">Roll Number</th>');
    parts.push('<th style="width:22%;">Candidate Signature</th>');
    parts.push('<th style="width:13%;">Remark</th>');
    parts.push('</tr>');
    parts.push('</thead>');
